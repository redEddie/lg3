"""Evaluation runner with visualization (notebook-like)."""
...
def _plot_one_day(
    run_name: str,
    day_start_ts: pd.Timestamp,
    y_true_24: np.ndarray,
    y_pred_24: np.ndarray,
    target_col: str,
    show_plots: bool,
    save_path: Path | None,
) -> None:
    ...
    for item in last_ckpts:
        ...
        for i in range(take):
            ...
            _plot_one_day(
                run_name=run_name,
                day_start_ts=day_ts,
                y_true_24=y_true_mat[i],
                y_pred_24=y_pred_mat[i],
